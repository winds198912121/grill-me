...
1. **1本のI/Fにかかる工数**は 要件定義10日 + 設計5日 + 開発20日 = **35人日**
2. **AIを使うと**各工程の工数が 70〜85% 圧縮され、1本 **5.5〜9人日** に
3. **1,200本にかける**と 35人日 × 1,200 = 42,000人日 だったのが 5.5〜9人日 × 1,200 = 6,600〜10,800人日 に

| | 1本あたり工数 | 1本あたり費用 | 1,200本 総費用 |
|------|-------------|-------------|--------------|
| **従来型** | 35人日 | ¥2M | ¥2.40B |
| **Tier A** | 5.5〜9人日 | ¥33万〜¥53万 | ¥396M〜¥636M |
| → **削減** | **−26〜−29.5人日** | **−¥1M〜−¥2M** | **−¥2.00B（84%）** |

#### 数字の内訳

| 工程 | 担当 | 単価 | 従来 | Tier A | 備考 |
|------|------|------|------|--------|------|
| 要件定義 | ｺﾝｻﾙ | ¥8万/日 | 10日 | 2〜3日 | 10日 → 2〜3日（70〜80%削減） |
| 基設計 | SE | ¥5万/日 | 5日 | 0.5〜1日 | 5日 → 0.5〜1日（80〜90%削減） |
| 開発+単体テスト | SE | ¥5万/日 | 20日 | 3〜5日 | 20日 → 3〜5日（75〜85%削減） |
| **合計** | | | **35日** | **5.5〜9日** | |
